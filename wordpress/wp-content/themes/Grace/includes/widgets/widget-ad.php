...
class suxingme_cjtz extends WP_Widget {
	...
	function suxingme_cjtz() {
		$this->__construct('suxingme_cjtz', '广告推荐 ', array( 'description' => '右栏广告' ));
	}
	...
	function widget($args, $instance) {
		...
		if($titlebb) {
			...
			echo '<div class="widget_cjtz_img" style="margin: -30px -20px -20px;">';
		}
