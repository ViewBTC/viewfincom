...
class suxingme_comment extends WP_Widget {
	function suxingme_comment() {
		$this->__construct('suxingme_comment', '最新评论 ', array( 'description' => '显示网友最新评论（名称+评论）' ));
