...
?>
		<ul class="recent-posts-widget">
			<?php
				...
				<?php if($i == 1){ ?>
					<li class="one">
						<div class="recent-posts-one-img"><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
							<?php if( suxingme('suxingme_timthumb_lazyload')) { ?>
								<img class="lazy thumbnail" data-original="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo post_thumbnail_src(); ?>&h=155&w=260&zc=1" src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo constant("THUMB_SMALL_DEFAULT");?>&h=155&w=260&zc=1" alt="<?php the_title(); ?>" />
							<?php }elseif (suxingme('suxingme_timthumb')) {	?>
								<img src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo post_thumbnail_src(); ?>&h=155&w=260&zc=1" alt="<?php the_title(); ?>" class="thumbnail"/>
							<?php } else { ?>
						...
						<div class="recent-posts-title">
							<span class="info" ><i class="icon-calendar-1"></i> <?php the_time('Y-n-j') ?></span>
				...
				<?php }else{ ?>
					<li>
						<div class="recent-posts-img"><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
							<?php if( suxingme('suxingme_timthumb_lazyload')) { ?>
								<img class="lazy thumbnail" data-original="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo post_thumbnail_src(); ?>&h=65&w=65&zc=1" src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo constant("THUMB_SMALL_DEFAULT");?>&h=65&w=65&zc=1" alt="<?php the_title(); ?>" />
							<?php }elseif (suxingme('suxingme_timthumb')) {	?>
								<img src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo post_thumbnail_src(); ?>&h=65&w=65&zc=1" alt="<?php the_title(); ?>" class="thumbnail"/>
							<?php } else { ?>
								<img src="<?php echo post_thumbnail_src(); ?>" alt="<?php the_title(); ?>" class="thumbnail" />
							<?php } ?>
