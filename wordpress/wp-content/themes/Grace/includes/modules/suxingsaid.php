...
<li>通过<a href=/wp-admin/options-permalink.php>固定连接</a>，通过这个设置，可以网站伪静态，具体教程请看<a href=//wp-courses/563.html target=_blank>《WORDPRESS常用固定链接（伪静态）格式》</a></li>
...
<li>最后，技术QQ：<a href=//go/qq target=_blank>12345678</a>  （09:00-18:00在线） 请在这期间咨询我！</li></ol>

</p>';
}
function example_add_dashboard_widgets() {
    wp_add_dashboard_widget('custom_help_widget', '主题使用教程', 'custom_dashboard_help');
}
