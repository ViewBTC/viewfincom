...
$options = array(
	...
	array(	"name" => "首页公告栏内容",
            ...
            "id" => "ygj_ggl_nr",
            "type" => "textarea",
            "std" => '<li class="scrolltext-title"><a href="http://yigujin.cn/blogs/" rel="bookmark" target="_blank">免费响应式博客主题Blogs</a></li><li class="scrolltext-title"><a href="http://yigujin.cn/nana/" rel="bookmark" target="_blank">WordPress免费响应式主题Nana</a></li>'),
	...
	array(	"name" => "友情链接ID",
            "desc" => '说明：默认显示友情链接ID为1，<a class="button-primary" href="http://yigujin.cn/500.html" target="_blank">友链添加教程</a>',
            "id" => "ygj_link_id",
            "type" => "number",
            "std" => 1),
    ...
    array(
        'name'  => '百度站点Token值',
        'desc'  => '填写在百度站长平台申请的Token值，<a class="button-primary" href="http://yigujin.cn/428.html" target="_blank">详细申请教程</a>',
        'id'    => "ygj_token_id",
        'type'  => 'text',
        'std'   => ''
    ),
    ...
    array(
        'name'  => '360自动收录私钥',
        'desc'  => '填写在360站长平台获得的私钥，<a class="button-primary" href="http://yigujin.cn/701.html" target="_blank">详细申请教程</a>',
        'id'    => "ygj_360sl_id",
        'type'  => 'text',
        'std'   => ''
    ),
...
版权声明：本文为原创文章，版权归 懿古今 所有，欢迎分享本文，转载请保留出处！'
	...
	array(	"name" => "页脚常用链接",
            ...
            "id" => "ygj_yjcylj",
            "type" => "textarea",
            "std" => '<li><span class="post_spliter">•</span><a href="http://yigujin.cn/nana/" target="_blank">Nana主题</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.cn/zbpnana/" target="_blank">zbpNana</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.cn/blogs/" target="_blank">Blogs主题</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.cn/722.html" target="_blank">去除版权</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.cn/unite/" target="_blank">Unite主题</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.cn/three/" target="_blank">Three主题</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.cn/673.html" target="_blank">NewUnite主题</a></li><li><span class="post_spliter">•</span><a href="http://boke112.com/" target="_blank">博客导航</a></li>'),
	...
	array(	"name" => "首页(列表页)第二广告代码（PC端）",
            ...
            "id" => "ygj_adh_cx",
            "type" => "textarea",
            "std" => '<a href="http://yigujin.cn/blogs/" target="_blank"><img src="' . get_template_directory_uri() . '/images/abc/adblogs.jpg" alt="免费响应式博客主题Blogs" /></a>'),
...
<div class="wrap">
    ...
    <div class="ygjtips">    
    <p>当前主题：Blogs&nbsp;1.0&nbsp;版 | 设计者：<a href="http://yigujin.cn/" target="_blank">懿古今</a> | <a href="http://yigujin.cn/722.html" target="_blank">赞助20元去版权</a> | 申请免费收录到 <a href="http://boke112.com/" target="_blank">boke112导航</a> </p>
    </div>
	<?php //获取所有站点分类id
...
<h2>主题介绍</h2>
<p>主题命名为Blogs，是因为这款主题专门为博客布局设计的，它是从<a target="_blank" href="http://yigujin.cn/nana/">Nana主题</a>的博客布局演变而言，首页、文章列表页共分为4种布局，侧边栏共分为3种布局，组合起来就有12种布局，希望有一款是你所喜欢的。</p>
<h2>特别声明</h2>
<p>Blogs主题是免费的，所以希望大家能够尊重我们的劳动成果，有钱出钱有力出力。换句话说就是：<font color="#ff0000">如果你赞助20元及以上的版权费，就可以正大光明地去除版权，并加入懿古今主题交流群（477678587）和添加到可以去除版权的赞助名单中；如果你不想赞助，希望你能够保留主题的版权链接，谢谢合作。</font></p>	
<p><font color="#ff0000">PS：如果不赞助本站，就直接删除版权的，对此我也无能为力，只能视你为人品不及格而已。</font></p>
<p><font color="#ff0000"><a target="_blank" href="http://yigujin.cn/blogs/">已赞助Blogs主题版权费的博客网站</a></font></p>	
<h2>支持懿古今</h2>
<p>如果您觉的这款主题很赞，欢迎您扫码支持懿古今！</p>
<p><font color="#ff0000">PS：赞助20元就可以光明正大地随意删除修改版权信息，并可加入懿古今主题交流群（477678587），不过这个群不提供主题使用的技术指导，但可与其他使用懿古今主题的用户交流。</font></p>
<p><font color="#ff0000">PS：赞助50元就可以光明正大地随意删除修改版权信息，并可加入懿古今主题官方群（28724788），这个群可以获得群主关于主题使用的技术指导，并可与其他使用Nana主题的用户交流。</font></p>
<p><font color="#ff0000">PS：赞助过版权费20元及以上的博客网站，都可以出现在Blogs主题的赞助名单中，具体名单请移步『<a target="_blank" href="http://yigujin.cn/blogs/">已赞助Blogs主题版权费的博客网站</a>』。</font></p>
<p><font color="#ff0000">PS：懿古今主题是免费主题，不提供免费的个性化修改，如需修改请支付费用，每次10-50元不等，面目全非的修改请绕道走人吧！</font></p>
<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/zhutisuoxuwushan.jpg"></img>
<h2>联系我们</h2>
<p>QQ号：2226524923</p>
<p>懿古今主题官方群：28724788<font color="#ff0000">（赞助后联系本人拉人进入）</font></p>
