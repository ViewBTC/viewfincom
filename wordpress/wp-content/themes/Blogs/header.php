...
<?php } ?>
<!--[if IE]>
<div class="tixing"><strong>x66666666666666温馨大提示：感谢您访问本站，经检测您使用的浏览器为IE浏览器，为了获得更好的浏览体验，请使用Chrome、Firefox或其他浏览器。</strong>
</div>
<![endif]-->
...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header xxxxiaohuan">
	<nav id="top-header">
		<div class="top-nav">
			<div id="user-profile">
