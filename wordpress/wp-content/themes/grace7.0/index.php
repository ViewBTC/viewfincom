<?php /* Template Name: homepage品牌商城 */ ?>
<?php get_header(); ?>
...
<body> -->
    ...
    <!-- index content begin -->
    <section id="home" class="zdyindexwrap">
        <div class="flexslider" id="home-slider">
            <ul class="slides">
                <li>
                    <img src="./viewfin/images/add-byxh/2.jpg" alt="">
                ...
                <li>
                    <img src="/viewfin/images/add-byxh/4.jpg" alt="">
                    <div class="slide-wrap">
                        <div class="slide-content">
                            <div class="container">
                                <h1 class="font-medium">Connects the World.</h1>
                                <h5>with a team of professionals.</h5>
                                <p class="mt-25"><a class="btn btn-color indexbalink" href="http://mvs.live/" target="_blank">Metaverse<span class="btn-icon"><i class="hc-play"></i></span></a></p>
                            </div>
                        </div>
                    </div>
                </li>
    ...
    <section class="pt-70 zdyindexwrap">
    ...
    <section class="grey-bg zdyindexwrap" id="tm">
        <div class="container-fluid">
            <div class="row">
        ...
        <div class="container pt-70">
            <div class="col-lg-7 col-sm-7 col-md-5">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="media-left"><span class="icon-box wow bounceIn"> <i class="hc-global"></i> </span> </div>
                        <div class="media-right">
                    ...
                    <div class="col-sm-12">
                        <div class="media-left"> <span class="icon-box wow bounceIn"> <i class="hc-news-paper"></i> </span> </div>
                        <div class="media-right">
                    ...
                    <div class="col-sm-12">
                        <div class="media-left"> <span class="icon-box wow bounceIn"> <i class="hc-monitor"></i> </span> </div>
                        <div class="media-right">
    ...
    <section id="tme" class="zdyindexwrap">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 col-sm-4 img-side img-left">
                    <div class="img-holder">
    ...
    <section id="tmw" class="grey-bg zdyindexwrap">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 col-sm-4 img-side img-right">
                    <div class="img-holder">
