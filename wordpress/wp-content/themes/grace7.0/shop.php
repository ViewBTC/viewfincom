        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 col-sm-4 img-side img-right">
                    <div class="img-holder">
                        <img class="img-responsive"  src="images/bg/about1.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="tme">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 col-sm-4 img-side img-left">
                    <div class="img-holder">
                        <img class="img-responsive" src="images/bg/about2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="tmw" class="grey-bg">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 col-sm-4 img-side img-right">
                    <div class="img-holder">
                        <img class="img-responsive" src="images/bg/about3.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
