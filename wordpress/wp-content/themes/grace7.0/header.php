...
<header id="topnav">
    <div class="container">
        ...
        <div class="logo">
            <a href="/">
             <img class="logo" src="/viewfin/images/logo_light.png" alt="">
        ...
        <div class="menu-extras">
            <div class="menu-item toggle-nav">
                <!-- Mobile menu toggle-->
                <a class="menu-toggle" href="#" onclick="$('#navigation').toggle();if($(this).hasClass('is-active')){$(this).removeClass('is-active');}else{$(this).addClass('is-active');$('#navigation').toggle();}">
        ...
        <div id="navigation">
            <ul class="navigation-menu nav">
                ...
                <li><a href="#team" onclick="$('#navigation').toggle()" data-scroll="true">Team</a>
                   ...
                   <li><a href="/author/root/" onclick="$('#navigation').toggle()" data-scroll="true">blog01</a>
                                </li>
